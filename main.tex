\documentclass[11pt]{scrartcl} % Evan uses KOMA-Script classes
\usepackage[utf8]{inputenc}
\usepackage[sexy]{evan} % This pulls in all his boxes, fonts, and shortcuts
...
\begin{proof}
    ...
    \textbf{Well-definedness and Injectivity:} We must show that $\phi$ is well-defined and injective, which amounts to proving that $g_1 H = g_2 H \iff g_1 \cdot x = g_2 \cdot x$. We observe the following chain of equivalences:
